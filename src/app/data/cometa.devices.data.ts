export const COMETA_DEVICES_DATA = {
    en: {
        ...
        cometa_laptop_automation: "Automation of human actions on websites made easy. 100% Open source made with 💚 for QAs, DevOps and Project Managers. Visual comparison with screenshots! Easy UI testing on over 2000 devices. REST API integrates easy and smooth. Webhooks alert you in your prefered messaging platform.",
        ...
        cometa_tablet_open_src: "Cometa.Rocks is a test automation platform that helps QA Testers and DevOps to easily create and maintain regression tests with a no-code approach and is available as open-source.",
    ...
    ca: {
        ...
        cometa_laptop_using_cometa: "L'ús de cometa ofereix molts avantatges per al vostre projecte.",
