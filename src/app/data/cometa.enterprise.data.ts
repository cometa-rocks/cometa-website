export const  COMETA_ENTERPRISE_DATA = {
    ...
    ca: {
        cometa_enterprise_title: "co.meta per a Enterprise",
        cometa_enterprise_desc: "El temps sempre significa diners. co.meta redueix les hores de prova a minuts o segons.",
        characteristics: [
            {
                image: "assets/enterprise/icons8-tick-box-96.webp",
