export const COMETA_PORTFOLIO_DATA = {
  en: {
    ...
    cometa_portfolio_automation: "co.meta is a web automation, ui testing tool to create organized ui tests online to check your project.",
    cometa_portfolio_tests: "co.meta continously tests functionality and performes visual regression tests with image comparison.",
    cometa_portfolio_development: "This will take your development to the next level.",
