export const  COMETA_PORTFOLIO_DATA = {
    en: {
        cometa_portfolio_title: "How does co.meta Work",
        cometa_portfolio_desc_automation: "co.meta is a web automation, ui testing tool to create organized ui tests online to check your project.",
        cometa_portfolio_desc_tests: "co.meta continously tests functionality and performes visual regression tests with image comparison.",
        cometa_portfolio_desc_development: "This will take your development to the next level.",
        cometa_portfolio_screenshots: "Enjoy the screenshots ... or try out co.meta and convince yourself. Request early access and get started in minutes.",
        cometa_portfolio_trial: "co.meta early access",
      screenshots: [
        {
            image: "assets/portfolio/StepEditor.webp",
          ...
          {
            image: "assets/portfolio/BrowserSelection.webp",
          ...
          {
            image: "assets/portfolio/SchedulePopup.webp",
          ...
          {
            image: "assets/portfolio/LiveSteps.webp",
            title: "Live steps",
            description: "See live what co.meta executes. Complex software made easy."
          },
          {
            image: "assets/portfolio/SearchFilters.webp",
          ...
          {
            image: "assets/portfolio/FeatureSorting.webp",
          ...
          {
            image: "assets/portfolio/FeatureResults.webp",
            title: "Test Results",
          ...
          {
            image: "assets/portfolio/FeatureStepResult.webp",
          ...
          {
            image: "assets/portfolio/FeatureResultScore.webp",
            title: "Result Score",
            description: "Result score gives a clean and fast overview of your testplan performance."
          },
          {
            image: "assets/portfolio/FeatureResultLog.webp",
          ...
          {
            image: "assets/portfolio/FeatureOptions.webp",
          ...
          {
            image: "assets/portfolio/AdminPanel.webp",
          ...
          {
            image: "assets/portfolio/EditFeatureInfo.webp",
          ...
          {
            image: "assets/portfolio/FeatureBox.webp",
            title: "Testplan Box",
          ...
          {
            image: "assets/portfolio/FeatureOptionsMenu.webp",
          ...
          {
            image: "assets/portfolio/ContinueOnFailure.webp",
    ...
    ca: {
        cometa_portfolio_title: "Com funciona co.meta",
        cometa_portfolio_automation: "co.meta és una eina de prova d'interfície d'usuari d'automatització web per crear organitzats proves d'interfície d'usuari en línia per comprovar el teu projecte.",
        cometa_portfolio_tests: "co.meta prova contínuament la funcionalitat i realitza proves de regressió visual amb comparació d'imatges.",
        cometa_portfolio_development: "Això portarà el vostre desenvolupament al següent nivell.",
        cometa_portfolio_screenshots: "Gaudeix de les captures de pantalla... o prova co.meta i convence't.",
        cometa_portfolio_trial: "co.meta trial",
      screenshots: [
        {
            image: "assets/portfolio/StepEditor.webp",
