...
function BDC_NormalizePath($p_Path) {
  ...
  $canonical .= '/';
  header("C.101: $canonical ");
  return $canonical;
}


header("C.201: require function ");
